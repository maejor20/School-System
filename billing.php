...
<br>
<div class="heading">
    <h2 class="text-center text-white text-uppercase" style="padding: 16px 18px;">Billing/Invoice</h2>
</div>
<div class="container">
    <form action="" method="post">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <br>
                <input type="number" name="libraryfees" class="form-control" required>
            </div>
            <div class="col-md-8">
                <div class="buttons">
                    <br>
